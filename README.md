# Python Plugin Getting Started Guide Example

This plugin is used as part of the
[Getting Started Guide](https://arcalot.io/arcaflow/getting-started/). The plugin is a
simplified "hello world" example and not intended for use as a supported plugin.
